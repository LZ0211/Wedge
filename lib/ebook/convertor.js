...
function filter(book){
    book.list = book.list.map(chapter=>Book.Chapter.set(chapter).valueOf())
    return book;
}

const Convertor = {
    wbk2wbk:filename=>Ebk.unwbk(readFile(filename),data=>Ebk.wbk(filter(data),svaeFile(filename,'wbk'))),
    ...
    wbk2txts:filename=>Ebk.unwbk(readFile(filename),data=>Ebk['txts.zip'](data,svaeFile(filename,'txts.zip'))),
    ...
    wbk2odt:filename=>Ebk.unwbk(readFile(filename),data=>Ebk.odt(data,svaeFile(filename,'odt'))),
    wbk2ebk3:filename=>Ebk.unwbk(readFile(filename),data=>Ebk.ebk3(data,svaeFile(filename,'ebk3'))),
    wbk2htmlz:filename=>Ebk.unwbk(readFile(filename),data=>Ebk.htmlz(data,svaeFile(filename,'htmlz'))),
    wbk2html:filename=>Ebk.unwbk(readFile(filename),data=>Ebk['html.zip'](data,svaeFile(filename,'html.zip'))),

    json2json:filename=>Ebk.json(filter(JSON.parse(readFile(filename).toString())),svaeFile(filename,'json')),
    ...
    json2txts:filename=>Ebk['txts.zip'](JSON.parse(readFile(filename).toString()),svaeFile(filename,'txts.zip')),
    ...
    json2odt:filename=>Ebk.odt(JSON.parse(readFile(filename).toString()),svaeFile(filename,'odt')),
    json2txtz:filename=>Ebk.txtz(JSON.parse(readFile(filename).toString()),svaeFile(filename,'txtz')),
    json2ebk3:filename=>Ebk.ebk3(JSON.parse(readFile(filename).toString()),svaeFile(filename,'ebk3')),
    json2htmlz:filename=>Ebk.htmlz(JSON.parse(readFile(filename).toString()),svaeFile(filename,'htmlz')),
    json2html:filename=>Ebk['html.zip'](JSON.parse(readFile(filename).toString()),svaeFile(filename,'html.zip')),

    db2db:filename=>Ebk.db(filter(readDB(filename)),svaeFile(filename,'db')),
    ...
    db2txts:filename=>Ebk['txts.zip'](readDB(filename),svaeFile(filename,'txts.zip')),
    ...
    db2odt:filename=>Ebk.odt(readDB(filename),svaeFile(filename,'odt')),
    ...
    db2ebk3:filename=>Ebk.ebk3(readDB(filename),svaeFile(filename,'ebk3')),
